<x-page-shell
    title="Comptabilité · Dépenses · Catégories"
    subtitle="Configurer les catégories de dépenses (paramétrable)."
>
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h3 class="text-base font-semibold text-gray-900">Catégories existantes</h3>
            <div class="mt-4 flex flex-wrap gap-2">
                @foreach (['Salaire', 'Entretien', 'Matériel', 'Transport', 'Autres'] as $category)
